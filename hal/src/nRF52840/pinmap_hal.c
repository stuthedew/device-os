...
Hal_Pin_Info __PIN_MAP[TOTAL_PINS] = {
...
/* D5 - SWDCLK   - 05 */ { NRF_PORT_NONE, 0,  PIN_MODE_NONE, PF_NONE, ADC_CHANNEL_NONE, PWM_INSTANCE_NONE, PWM_CHANNEL_NONE, 8, EXTI_CHANNEL_NONE},
/* D6 - SWDIO    - 06 */ { NRF_PORT_NONE, 0,  PIN_MODE_NONE, PF_NONE, ADC_CHANNEL_NONE, PWM_INSTANCE_NONE, PWM_CHANNEL_NONE, 8, EXTI_CHANNEL_NONE},
/* D7            - 07 */ { NRF_PORT_1,    11, PIN_MODE_NONE, PF_NONE, ADC_CHANNEL_NONE, 0,                 0,                8, EXTI_CHANNEL_NONE},
...
/* C4            - 26 */ { NRF_PORT_0,    24, PIN_MODE_NONE, PF_NONE, ADC_CHANNEL_NONE, 1,                 2,                8, EXTI_CHANNEL_NONE},
...
const uint8_t NRF_PIN_LOOKUP_TABLE[48] = {
    ...
    34,          PIN_INVALID, PIN_INVALID, PIN_INVALID, PIN_INVALID, PIN_INVALID, PIN_INVALID, PIN_INVALID, /* P0.16 ~ P0.23 */
    26,          28,          29,          30,          10,          11,          12,          13,          /* P0.24 ~ P0.31 */
    PIN_INVALID, 0,           1,           27,          41,          40,          38,          39,          /* P1.00 ~ P1.07 */
    22,          23,          2,           7,           18,          19,          20,          21,          /* P1.08 ~ P1.15 */
};
